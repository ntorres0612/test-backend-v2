...
public class UserController {
	...
	public String hello(){
		return "Hello world" + appProperties.getEmailPatter() + "  ....  " + appProperties.getPasswordPatter();
	}
	...
	public ResponseEntity<?> update( @RequestBody UserRequest userRequest) {
		try {
			...
			if( !UtilsFn.getInstance().validateEmail(userRequest.getEmail(), appProperties.getEmailPatter())) {
				return  ResponseEntity.ok(new CustomResponse("error", "Invalid email"));
			}
			if( !UtilsFn.getInstance().validatePassword(userRequest.getPassword(), appProperties.getPasswordPatter())) {
